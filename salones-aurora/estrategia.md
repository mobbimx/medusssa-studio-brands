# Salones Aurora — Estrategia de Contenido

## Plataformas activas
| Plataforma | Rol | Prioridad |
|------------|-----|-----------|
| Facebook | Principal — alcance local, eventos | Alta |
| WhatsApp | Cotizaciones y agendado | Alta |
| Instagram | Imagen de marca, fotos de eventos | Media |

## Pilares de contenido
1. **Eventos reales** — Fotos/videos de fiestas celebradas
2. **Instalaciones** — Tours virtuales, detalles del salón
3. **Testimonios** — Experiencias de familias
4. **Promocional** — Paquetes, disponibilidad, cotizaciones
